...
public class HouseController {
    ...
    @GetMapping({"/house/{id}","/jwt/house/{id}"})
    ...
    @PutMapping({"/house/{id}","/jwt/house/{id}"})
    ...
    @DeleteMapping({"/house/{id}","/jwt/house/{id}"})
