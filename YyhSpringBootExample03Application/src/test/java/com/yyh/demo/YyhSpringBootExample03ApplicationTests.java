...
class YyhSpringBootExample03ApplicationTests {
	...
	public void testWebLogin() throws Exception{
		...
		try {
			RequestBuilder requestBuilder =  MockMvcRequestBuilders.post("http://localhost:3000/processLogin")
					.param("email", "howard@gmail.com")
					.param("password", "1234");
